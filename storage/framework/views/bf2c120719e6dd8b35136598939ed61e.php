    ...
    <!--[if BLOCK]><![endif]--><?php if($modalOpen): ?>
        <div class="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-40">
            <div class="bg-white rounded-lg shadow-lg w-full max-w-md p-6">
                <h2 class="text-lg font-bold mb-4"><?php echo e($modalMode === 'create' ? 'Nuevo Estado' : 'Editar Estado'); ?></h2>
                <form wire:submit.prevent="save">
                    <div class="mb-4">
                        <label class="block text-gray-700">Nombre</label>
                        <input type="text" wire:model.defer="nombre" maxlength="50" class="w-full border rounded px-3 py-2 mt-1 <?php $__errorArgs = ['nombre'];
...
unset($__errorArgs, $__bag); ?>" placeholder="Ej: Vigente" />
...
unset($__errorArgs, $__bag); ?>" placeholder="Descripción del estado" />
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div class="mb-4">
                        <label class="block text-gray-700">Color (hex)</label>
                        <input type="color" wire:model.defer="color" class="w-16 h-8 border rounded" />
...
<?php /**PATH C:\xampp\htdocs\sisogrsu1\resources\views/livewire/partials/modal-form-estado.blade.php ENDPATH**/ ?>