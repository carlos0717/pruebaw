    ...
    <div class="bg-white rounded-lg shadow-lg w-full max-w-2xl p-6 relative">
        ...
        <div class="mb-2">
            <!--[if BLOCK]><![endif]--><?php if($institucion_id): ?>
                <?php $institucion = App\Models\Institucion::find($institucion_id); ?>
                <!--[if BLOCK]><![endif]--><?php if($institucion): ?>
                <div class="bg-blue-100 text-blue-800 px-3 py-2 rounded flex items-center justify-between mb-2">
                    <span><?php echo e($institucion->nombre); ?> (<?php echo e($institucion->tipo->nombre ?? 'Sin tipo'); ?>)</span>
            ...
            <ul>
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->searchInstituciones($institucion_search); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inst): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="flex items-center justify-between px-3 py-2 border-b hover:bg-blue-50">
                        ...
                        <button wire:click="$set('institucion_id', <?php echo e($inst->id); ?>)" 
                ...
                <form wire:submit.prevent="saveNewInstitucion">
                    ...
                    <div class="mb-2">
                        ...
                        <select wire:model.defer="newInstitucion.institucion_tipo_id" class="w-full border rounded px-3 py-2 focus:ring-2 focus:ring-blue-400" required>
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $tiposInstitucion; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\xampp\htdocs\sisogrsu1\resources\views/livewire/partials/institucion-modal.blade.php ENDPATH**/ ?>