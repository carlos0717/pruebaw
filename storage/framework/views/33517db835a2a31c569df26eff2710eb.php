    ...
    <!--[if BLOCK]><![endif]--><?php if($modalOpen): ?>
        <div class="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-40">
            <div class="bg-white rounded-lg shadow-lg w-full max-w-md p-6">
                <h2 class="text-lg font-bold mb-4"><?php echo e($modalMode === 'create' ? 'Nueva Institución' : 'Editar Institución'); ?></h2>
...
unset($__errorArgs, $__bag); ?>" placeholder="Nombre de la institución" />
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div class="mb-4">
                        ...
                        <select wire:model.defer="institucion_tipo_id" class="w-full border rounded px-3 py-2 mt-1 <?php $__errorArgs = ['institucion_tipo_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['institucion_tipo_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="Descripción de la institución" />
...
<?php /**PATH C:\xampp\htdocs\sisogrsu1\resources\views/livewire/partials/modal-form-institucion.blade.php ENDPATH**/ ?>