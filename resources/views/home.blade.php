                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide h-full">
                            <div class="bg-white rounded-lg shadow-md flex flex-col overflow-hidden h-full">
                                <img src="{{ $noticia->imagen_path ? asset('storage/' . $noticia->imagen_path) : '/images/escudo_unasam.png' }}" alt="{{ $noticia->titulo }}" class="h-40 w-full object-cover bg-gray-100">
                                <div class="p-4 flex-1 flex flex-col">
                                    <h3 class="font-bold text-blue-800 text-lg mb-2 line-clamp-2">
                                        <a href="{{ route('noticias.show', $noticia->id) }}" class="hover:underline hover:text-blue-600 transition-colors duration-150">
                                            {{ $noticia->titulo }}
                                        </a>
                                    </h3>
                                    <span class="text-xs text-gray-500 mb-2">{{ $noticia->area_origen }} | {{ \Carbon\Carbon::parse($noticia->fecha_publicacion)->format('d/m/Y H:i') }}</span>
                                    <!-- <p class="text-gray-700 text-sm line-clamp-3 mb-4">{{ $noticia->descripcion }}</p> -->
                                    <a href="{{ route('noticias.show', $noticia->id) }}" class="mt-auto text-blue-700 hover:underline font-medium text-sm">Leer más</a>
                                </div>
                            </div>
                        </div>
                        @empty
            ...
            <div class="px-0">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                    ...
                    <div class="bg-white rounded-lg shadow-md flex flex-col overflow-hidden">
                        <img src="{{ $noticia->imagen_path ? asset('storage/' . $noticia->imagen_path) : '/images/escudo_unasam.png' }}" alt="Miniatura" class="h-32 w-full object-cover bg-gray-100">
                        <div class="p-4 flex-1 flex flex-col">
                    ...
                    @empty
                    <div class="col-span-4 text-center text-gray-500 py-8">No hay noticias registradas.</div>
                    @endforelse
                </div>
            </div>
        </section>                                    
